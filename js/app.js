...
function initTopPage() {
    ...
    for (var i in list) {
        ...
        $li = $("<li><a href='#' class='show'><h4></h4><h6></h6></a><a href='#' class='delete'>Delete</a></li>");
        $li.data("id", memo.id);
        $li.find("h4").text(date);
        $li.find("h6").text(memo.text);
...
function onShowLink() {
    ...
    var memoHtml = $li.find("h6").html().replace(/\n/g, "<br>");
